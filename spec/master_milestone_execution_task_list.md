# Master Milestone Execution Task List: InterviewShield
...
Granular, dependency-ordered execution roadmap mapping all architectural specifications, presentation requirements, professional frontend design tokens from `assets/`, and detection pipelines into verified, zero-guesswork implementation milestones.
...
Every milestone subsection must have its own dedicated sub-implementation plan adhering to the 7-Layer System Design architecture (Routing Guide `spec_universal/system_design/00_` through `07_`) with embedded 4-tier TDD before execution.
...
Deterministic mapping of all 15 specification documents, design assets, and presentation slides to their designated execution milestones.

```yaml
specification_document_dependency_matrix:
  layer_0_foundations_and_design_assets:
    - doc_path: "assets/Design (1).md"
      target_milestone: "M00_FOUNDATION_TOOLCHAIN_AND_BASELINES"
      subsections: ["M00.4", "M00.5"]
    - doc_path: "assets/general-team-settings-dashboard.tailwind-v4.Woblo.css"
      target_milestone: "M00_FOUNDATION_TOOLCHAIN_AND_BASELINES"
      subsections: ["M00.5"]
    - doc_path: "assets/general-team-settings-dashboard.shadcn.Woblo.css"
      target_milestone: "M00_FOUNDATION_TOOLCHAIN_AND_BASELINES"
      subsections: ["M00.5"]
    - doc_path: "assets/general-team-settings-dashboard.dtcg.Woblo.tokens.json"
      target_milestone: "M00_FOUNDATION_TOOLCHAIN_AND_BASELINES"
      subsections: ["M00.5"]
    - doc_path: "DESIGN.md"
      target_milestone: "M00_FOUNDATION_TOOLCHAIN_AND_BASELINES"
  ...
  layer_1_presentation_and_product_definition:
    - doc_path: "spec/CORE/CodeX 2026 Presentation Sample.pptx.pdf"
      target_milestone: "ALL_MILESTONES"
      subsections: ["M01" - "M08"]
      core_slide_mappings:
        slide_04_problem_and_vectors: "M03 (Face-Swap, Proxy), M04 (Lip-Sync, Voice), M01 (Screen/Tab)"
        slide_06_how_it_works: "M06 (Join), M03/M04 (AI Monitor), M05 (Score), M07/M08 (Actionable Report)"
        slide_07_technical_approach: "M01 (Capture), M03 (Visual), M04 (Audio/Speech), M05 (Fusion), M07 (Review)"
        slide_08_feasibility_and_impact: "M00 (Tech Stack), M02 (Cost Profile), M08 (Verification)"
        slide_10_solution_summary: "M03/M04/M05/M07/M08 (End-to-End Pipeline & Real-Time Evidence)"
    - doc_path: "spec/prd.md"
      target_milestone: "M05_MULTIMODAL_RISK_FUSION_ENGINE"
      subsections: ["M05.1", "M05.2", "M05.3"]

  layer_2_macro_architecture_and_topology:
    - doc_path: "spec/hld_architecture.md"
      target_milestone: "M01_INGRESS_AND_WEBSOCKET_TELEMETRY"
      subsections: ["M01.1", "M01.3", "M01.4", "M01.5"]

  layer_3_persistence_and_pool_physics:
    - doc_path: "spec/backend_design_and_data_model.md"
      target_milestone: "M02_PERSISTENCE_AND_POOL_PHYSICS"
      subsections: ["M02.1", "M02.2", "M02.3", "M02.4", "M02.5"]

  layer_4_user_journeys_and_state_mapping:
    - doc_path: "spec/app_flow_and_state_map.md"
      target_milestone: "M06_CANDIDATE_EXPERIENCE_UI"
      subsections: ["M06.1", "M06.2", "M06.3", "M06.4"]

  layer_5_visual_system_and_tokens:
    - doc_path: "spec/ui_ux_design_brief.md"
      target_milestone: "M07_RECRUITER_COMMAND_CENTER"
      subsections: ["M07.1", "M07.2", "M07.3"]

  layer_6_production_sre_and_compliance:
    - doc_path: "spec/operations_telemetry_and_sre.md"
      target_milestone: "M08_SRE_TELEMETRY_AND_PRODUCTION_HARDENING"
      subsections: ["M08.1", "M08.2", "M08.3", "M08.4"]
    - doc_path: "spec/authoritative_references_and_standards.md"
      target_milestone: "M08_SRE_TELEMETRY_AND_PRODUCTION_HARDENING"
      subsections: ["M08.3"]
```
...
master_execution_milestones:
  ...
  - milestone_id: "M00_FOUNDATION_TOOLCHAIN_AND_BASELINES"
    phase_name: "Monorepo Workspace Scaffolding, Toolchain Pinning & Design Token Engine"
    ...
    subsections:
      - subsection_id: "M00.1"
        ...
        scope: "Initialize root package.json with npm workspaces (packages/shared, apps/server, apps/client), root tsconfig.json in strict mode, oxlint configuration, and vitest test harness."
      - subsection_id: "M00.2"
        ...
        scope: "Author docker-compose.yml deploying PostgreSQL 16 Alpine with custom postgresql.conf tuning (shared_buffers=256MB, max_connections=20), local NVMe persistent volume, and pg_isready healthcheck."
      - subsection_id: "M00.3"
        ...
        scope: "Verify native .githooks/pre-commit blocking commits to spec_universal/ and .agents/AGENTS.md, configure .agents/hooks.json for destructive command prevention, and set core.hooksPath."
      - subsection_id: "M00.4"
        name: "Shared Contract Type Definitions & Zod Schemas"
        subplan_target: "spec/subplans/M00_4_shared_contracts.subplan.md"
        scope: "Implement shared/src/ (events.ts, risk.ts, ws-protocol.ts, auth.ts) with strict Zod validation schemas and zero-dependency TypeScript interface exports."
      - subsection_id: "M00.5"
        ...
        scope: "Extract OKLCH palettes, subpixel 1px ring shadows, and 11px-20px typography scale from assets/ into client/src/styles/theme.css and tailwind.config.ts, creating complete Shadcn/Radix CSS variable mappings."
    validation_gate:
      exit_criteria:
  ...
  - milestone_id: "M01_INGRESS_AND_WEBSOCKET_TELEMETRY"
    ...
    subsections:
      - subsection_id: "M01.1"
        ...
        scope: "Configure Express app with Helmet security headers, CORS origin whitelist, JSON body parser (1MB cap), and client/vite.config.ts reverse proxy (/api -> :3001, /ws -> :3001)."
      - subsection_id: "M01.2"
        ...
        scope: "Attach ws.WebSocketServer to HTTP server on /ws/session/:id. Authenticate via Sec-WebSocket-Protocol: interviewshield-v1, <token> to prevent query string credential leakage (VULN-03)."
      - subsection_id: "M01.3"
        ...
        scope: "Implement per-socket rate limiter enforcing max 10 frames/sec burst and 64KB max payload size. Drop abusive frames and emit session:error code 4029."
      - subsection_id: "M01.4"
        ...
        scope: "Implement per-session sliding window journal (size 50) tracking last_received_sequence. Acknowledge and drop duplicate replayed sequence numbers without double-scoring."
      - subsection_id: "M01.5"
        ...
        scope: "Send server ping every 15s; require client pong within 5s. Terminate stale sockets after 45s of silence. Broadcast close frame 1001 ('Going Away') during graceful shutdown."
    validation_gate:
      exit_criteria:
  ...
  - milestone_id: "M02_PERSISTENCE_AND_POOL_PHYSICS"
    ...
    subsections:
      - subsection_id: "M02.1"
        ...
        scope: "Author prisma/schema.prisma for recruiters, interviews, sessions, detection_events, risk_snapshots, evidence_items, recruiter_reviews, session_encryption_keys, and audit_logs."
      - subsection_id: "M02.2"
        ...
        scope: "Store only SHA-256 hash (join_token_hash) in database with unique B-tree index. Implement crypto.timingSafeEqual comparison service."
      - subsection_id: "M02.3"
        ...
        scope: "Configure Prisma pool to exactly 5 connections ((2 * 2 vCPU) + 1), connection timeout 2s, and idle timeout 10s to eliminate queue thrashing."
      - subsection_id: "M02.4"
        name: "Dual-Phase GDPR Crypto-Shredding Engine"
        subplan_target: "spec/subplans/M02_4_crypto_shredding_engine.subplan.md"
        scope: "Implement session_encryption_keys table storing AES-256 data keys. Phase 1 destroys DEK in < 5ms (shredding ciphertext); Phase 2 unlinks physical JPEGs and scrubs DB PII."
      - subsection_id: "M02.5"
        name: "Tamper-Evident SHA-256 Merkle Audit Log Service"
        subplan_target: "spec/subplans/M02_5_merkle_audit_log.subplan.md"
        scope: "Implement audit_logs table with cryptographic hash chaining (record_hash = SHA256(seq + prev_hash + action + operator + ts + payload_hash))."
      - subsection_id: "M02.6"
        name: "Database Seeder & Demonstration Dataset"
        subplan_target: "spec/subplans/M02_6_database_seed_demo.subplan.md"
        scope: "Author prisma/seed.ts creating demo recruiter (recruiter@demo.interviewshield.dev / bcrypt cost 12), sample completed interview, and realistic timeline events."
    validation_gate:
      exit_criteria:
  ...
  - milestone_id: "M03_CLIENT_VISUAL_DETECTION_PIPELINE"
    ...
    subsections:
      - subsection_id: "M03.1"
        ...
        scope: "Initialize @mediapipe/tasks-vision WebAssembly runtime with offline model asset caching (blaze_face_short_range.tflite) and offscreen canvas processing."
      - subsection_id: "M03.2"
        ...
        scope: "Implement requestAnimationFrame throttling executing inference at exactly 500ms intervals (170ms compute budget, 330ms thread idle time per HLD math)."
      - subsection_id: "M03.3"
        name: "Face Absence & Multiple Faces Presence Detector"
        subplan_target: "spec/subplans/M03_3_face_presence_detector.subplan.md"
        scope: "Detect face count: 0 faces for >= 3s triggers face_absent; >= 2 faces for >= 1s triggers multiple_faces. 3-second debounce to avoid false alarms on brief yaw turns."
      - subsection_id: "M03.4"
        name: "Facial Landmark Mesh & Gaze/Eye Movement Tracker"
        subplan_target: "spec/subplans/M03_4_landmark_gaze_tracker.subplan.md"
        scope: "Extract 468 landmarks via FaceLandmarker. Calculate iris center offset relative to eye corners. Persistent off-screen gaze (> 25 deg for > 4s) triggers unusual_gaze_direction."
      - subsection_id: "M03.5"
        ...
        scope: "Analyze face boundary blend zones for Laplacian edge variance drop, unnatural color gamut mismatch between face box and neck skin, and temporal landmark jitter (> 12px std dev)."
      - subsection_id: "M03.6"
        name: "Sparse Evidence JPEG Snapshot Extractor (< 50KB)"
        subplan_target: "spec/subplans/M03_6_sparse_snapshot_extractor.subplan.md"
        scope: "When severity >= WARN, capture 640x480 offscreen frame, compress to JPEG quality 0.65 (guaranteeing <= 50KB), and attach to outbound violation payload."
    validation_gate:
      exit_criteria:
  ...
  - milestone_id: "M04_AUDIO_SPEECH_AND_LIPSYNC_CORRELATION"
    ...
    subsections:
      - subsection_id: "M04.1"
        ...
        scope: "Create AudioContext with AnalyserNode (fftSize=1024, smoothingTimeConstant=0.8). Calculate RMS volume and isolate speech band energy (300 Hz - 3400 Hz)."
      - subsection_id: "M04.2"
        ...
        scope: "Voice activity detection via energy thresholding. RMS volume < -45 dBFS for >= 10 consecutive seconds triggers audio_silence_extended event."
      - subsection_id: "M04.3"
        ...
        scope: "Integrate Web Speech API (webkitSpeechRecognition) with whisper.wasm fallback. Transcribe candidate speech in real time for content indexing and keyword matching."
      - subsection_id: "M04.4"
        name: "Facial Viseme Mouth Openness Metric Extractor"
        subplan_target: "spec/subplans/M04_4_mouth_viseme_extractor.subplan.md"
        scope: "Extract lip distance ratio: vertical aperture (landmark 13 to 14) / horizontal width (landmark 61 to 291). Normalize metric between 0.0 (closed) and 1.0 (wide open)."
      - subsection_id: "M04.5"
        ...
        scope: "Sample lip aperture and audio RMS energy at 10 Hz into sliding 5s ring buffers (50 samples). Calculate Pearson correlation r. If speech active and r < 0.25 for > 3s, emit audio_video_mismatch."
      - subsection_id: "M04.6"
        name: "Tab & Screen Visibility Lifecycle Monitor"
        subplan_target: "spec/subplans/M04_6_tab_screen_monitor.subplan.md"
        scope: "Listen to document.visibilitychange and window.onblur/onfocus. Switching tabs emits tab_hidden with confidence 1.0; returning emits tab_restored with hidden duration delta."
    validation_gate:
      exit_criteria:
  ...
  - milestone_id: "M05_MULTIMODAL_RISK_FUSION_ENGINE"
    ...
    subsections:
      - subsection_id: "M05.1"
        ...
        scope: "Implement pure function calculateRisk(RiskCalculationInput): RiskCalculationResult in server/src/risk/engine.ts. Guarantee 100% deterministic reproducibility with zero side effects."
      - subsection_id: "M05.2"
        ...
        scope: "Implement weight deductions: face_absent (-15), multiple_faces (-15), face_swap_detected (-15), audio_video_mismatch (-10), voice_cloning_detected (-15), tab_hidden (-5), unusual_gaze (-3), audio_silence (-2)."
      - subsection_id: "M05.3"
        name: "Per-Event Cooldown Suppression Timer State Machine"
        subplan_target: "spec/subplans/M05_3_cooldown_timers.subplan.md"
        scope: "Implement cooldown suppression windows: face_absent (30s), multiple_faces (30s), face_swap (60s), tab_hidden (15s), audio_mismatch (30s). Suppressed events log timeline warning without score drop."
      - subsection_id: "M05.4"
        ...
        scope: "Award +2 points per full minute of clean time, bounded by peakScore. Trigger evaluation on session:heartbeat (every 15s), session:end, and score read to eliminate passive session freeze."
      - subsection_id: "M05.5"
        ...
        scope: "Map score to tiers: 100-85 (Normal/Green), 84-70 (Attention/Amber), 69-50 (Suspicious/Orange), <50 (High Risk/Red). Emit risk_state_changed event on tier boundary crossing."
      - subsection_id: "M05.6"
        ...
        scope: "Implement server/src/risk/explainer.ts compiling top 3 deduction factors, duration of clean time, and clear, non-punitive summaries for recruiter review."
    validation_gate:
      exit_criteria:
  ...
  - milestone_id: "M06_CANDIDATE_EXPERIENCE_UI"
    ...
    subsections:
      - subsection_id: "M06.1"
        ...
        scope: "Scaffold CandidateLayout using semantic tokens from assets/ and DESIGN.md (Canvas oklch(0.1286 0 0), Subpixel 1px rings rgba(255,255,255,0.14), GeistSans typography, WCAG 2.2 AA contrast)."
      - subsection_id: "M06.2"
        ...
        scope: "Build JoinGatePage validating token via GET /api/interviews/join/:token. Prompt for navigator.mediaDevices permissions with clear browser-specific guidance."
      - subsection_id: "M06.3"
        ...
        scope: "Build device check screen with video mirror preview, real-time green-to-red audio volume bar, browser WebAssembly compatibility check, and network ping test."
      - subsection_id: "M06.4"
        ...
        scope: "Implement inverted consent gate: monitoring is completely inactive until candidate checks affirmative box ('I consent to local video/audio integrity analysis') and clicks 'Begin Interview'."
      - subsection_id: "M06.5"
        ...
        scope: "Build candidate view: PIP webcam preview, subtle green/amber status dot, interview question prompt, note-taking scratchpad, and 'End Interview' action. BANS candidate score display."
      - subsection_id: "M06.6"
        name: "CompletionPage: Clean Device Teardown & Session Signoff"
        subplan_target: "spec/subplans/M06_6_completion_page.subplan.md"
        scope: "Build exit screen cleanly stopping all MediaStream tracks (track.stop()), displaying interview completion confirmation, and providing post-interview FAQ."
    validation_gate:
      exit_criteria:
  ...
  - milestone_id: "M07_RECRUITER_COMMAND_CENTER"
    ...
    subsections:
      - subsection_id: "M07.1"
        ...
        scope: "Build recruiter command center with search, status filters (Pending, In Progress, Completed), risk badges, pagination, and 'Create Interview' modal using compact table patterns from assets/."
      - subsection_id: "M07.2"
        ...
        scope: "Build SVG radial score gauge animating smoothly from 0 to 100 with dynamic color interpolation (Emerald -> Amber -> Orange -> Rose) and tabular Geist Mono score digits."
      - subsection_id: "M07.3"
        ...
        scope: "Build timeline list using @tanstack/react-virtual rendering up to 1,000 events at 60 FPS, with 11px/12px timestamp badges, severity icons, and expandable drawer triggers."
      - subsection_id: "M07.4"
        ...
        scope: "Build focus-trapped dialog displaying stored evidence JPEG via GET /api/evidence/:id/file, showing timestamp, confidence score, detected bounding boxes, and zoom controls with subpixel border rings."
      - subsection_id: "M07.5"
        ...
        scope: "Build review card with Pass / Flag / Inconclusive decision buttons. Enforce mandatory text notes when verdict is 'Flag'. Persist review and lock session."
      - subsection_id: "M07.6"
        ...
        scope: "Verify Ideal, Loading (geometry-preserving skeleton), Empty (actionable zero-state), Validation, Error, and Offline banner across all recruiter views."
    validation_gate:
      exit_criteria:
  ...
  - milestone_id: "M08_SRE_TELEMETRY_AND_PRODUCTION_HARDENING"
    ...
    subsections:
      - subsection_id: "M08.1"
        ...
        scope: "Implement server/src/services/report.service.ts compiling candidate summary, risk score gauge, four-pillar integrity checklist (Identity Verification, Face Manipulation, Voice Cloning, Screen/External Help), top deductions, and timestamped evidence snapshot embeds into print-ready A4 PDF."
      - subsection_id: "M08.2"
        ...
        scope: "Deploy PromQL alert rules: Page Alert (14.4x burn rate, 1h + 5m dual-window with increase() >= 50 guard), Ticket Alert (6x burn rate, 6h + 30m dual-window), and Disconnect Surge Alert."
      - subsection_id: "M08.3"
        ...
        scope: "Verify Tier 1 Liveness (/api/health/live), decoupled Tier 2 Readiness (/api/health/ready), and Tier 3 Startup (/api/health/startup). Test container preStop 15s hook and WS 1001 drain."
      - subsection_id: "M08.4"
        name: "Automated 16 Robustness Test Scenarios Execution"
        subplan_target: "spec/subplans/M08_4_robustness_scenarios.subplan.md"
        scope: "Execute all 16 robustness scenarios from docs/TEST_PLAN.md (rapid tab switching, audio packet loss, partial face occlusion, sequence replay, network reconnect)."
      - subsection_id: "M08.5"
        name: "Post-Code Dead Code & Orphaned Symbol Sweep (Rule 31)"
        subplan_target: "spec/subplans/M08_5_dead_code_sweep.subplan.md"
        scope: "Perform repository-wide sweep pruning unused imports, dead mock fixtures, and temporary scratch scripts. Verify zero TS6133 compiler warnings."
      - subsection_id: "M08.6"
        ...
        scope: "Execute `graphify update .` to synchronize AST nodes, verify 100% connected components, and log manifest in graphify-out/."
    validation_gate:
      exit_criteria:
